angular.module('adminExpandDayPlan', ['ngAutocomplete'])
    .controller('adminDayDeliveriesPlanController', function ($location, $window, $scope, $http, $anchorScroll) {
        ...
        function getRoutes(week, day) {
            ...
            $http.get('/routes/' + week + '/' + day,{params:{userId:$scope.selectedClient._id}}).then(function (res) {
        ...
        $scope.getRoutesPDF = function () {
            ...
            window.location.href = "/routesPDF?day=" + day + "&week=" + week+"&userId="+ $scope.selectedClient._id;
        }
